...
services:
  ...
  hellgate:
    image: dr.rbkmoney.com/rbkmoney/hellgate:68715b8c38b3a4126d855e5312807025a89d4a38
    restart: always
  ...
  dominant:
    image: dr.rbkmoney.com/rbkmoney/dominant:2564fdbc04aefb6f97d12971f347a349a456dea4
    restart: always
