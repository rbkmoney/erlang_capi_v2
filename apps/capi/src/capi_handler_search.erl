...
decode_bank_card_details(BankCard, V) ->
    Last4 = capi_handler_decoder_utils:decode_last_digits(BankCard#merchstat_BankCard.masked_pan),
    First6 = capi_handler_decoder_utils:decode_first_digits(BankCard#merchstat_BankCard.bin),
