...
prepare_request(OperationID, _Req, _Context) when
    OperationID =:= 'CreateInvoiceTemplate'
        orelse OperationID =:= 'GetInvoiceTemplateByID'
        orelse OperationID =:= 'UpdateInvoiceTemplate'
        orelse OperationID =:= 'DeleteInvoiceTemplate'
        orelse OperationID =:= 'CreateInvoiceWithTemplate'
        orelse OperationID =:= 'GetInvoicePaymentMethodsByTemplateID'
->
    {ok, #{}};
